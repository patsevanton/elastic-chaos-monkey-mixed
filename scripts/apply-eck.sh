...
cd "$ROOT"
: "${KIBANA_INGRESS_PASSWORD:?задайте KIBANA_INGRESS_PASSWORD}"
...
HTPASSWD="$(htpasswd -nbB kibana "$KIBANA_INGRESS_PASSWORD")"
kubectl -n elastic create secret generic kibana-basic-auth \
